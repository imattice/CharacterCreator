...
class ClassRecord: Record, Codable {
    ...
    internal init(name: String, description: String, hitDie: Int, proficincies: ClassRecord.ClassProficiencies, features: [Feature], subClasses: [SubclassRecord], equipment: [Selection]) {
        ...
        self.hitDie = hitDie
        self.proficiencies = proficincies
    ...
    init(from decoder: Decoder) throws {
        ...
        self.subClasses     = try container.decodeIfPresent([SubclassRecord].self, forKey: .subclasses) ?? [SubclassRecord]()
    ...
    enum CodingKeys: CodingKey {
        case name, description, hitDie, proficiencies, features, subclasses, equipmentOptions
    }
}
