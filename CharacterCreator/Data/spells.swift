...
//MARK: Level 1 Spells
	...
	"Augury": [
	   ...
	   "duration": "instant",
	   "isRitual": true,
	   "description": "Reach into the timeline to fore the outcomes of any action that will be taken within the immediate future.  Consecutive uses of this spell reduce its effectiveness." ],
	"Blur": [
		"level": "2",
		"school": "illusion",
		"cast": "1 action",
		...
		"requiresConcentration": true,
		"duration": "1 minute",
		"description": "Obscure the line of your own existance, fading in and out of an illusory state.  Any foe that attempts to strike you has difficulty landing their attack." ],
	"Darkness": [
		"level": "2",
		"school": "evocation",
		"cast": "1 action",
		...
		"shape": [
			"size": "15",
			"shape": "sphere" ],
		"description": "Summon a blob of pure, magical blackness that consumes all light within its grasp and prevents even creatures attuned with darksight from seeing." ],
	"Flaming Sphere": [
		"level": "2",
		"school": "conjuration",
		"cast": "1 action",
		...
		"damage": [
			...
			"type": "fire",
			"multiplier": "2"],
		"description": "Create a perfect ball of fire and heat that spreads light and ignites objects within its path.  Any creature that comes in contact with the sphere could suffer terrible burns."],
	"Hold Person": [
		"level": "2",
		"school": "enchantment",
		"cast": "1 action",
		...
		"save": [
			"stat": "wis",
			"success": "no_effect" ],
		"description": "Lock a being in place, stiffening its muscles and preventing it from moving in the slightest." ],
	"Invisibility": [
		"level": "2",
		"school": "illusion",
		"cast": "1 action",
	...
	"Levitate": [
		...
		"save": [
			"stat": "con",
			"success": "no_effect" ],
		"description": "Magically lift a target in the air.  While in the air, you can manipulate their position in space until the spell ends, where the leviation magic slowly gives away and places them back on the ground." ],
	"Magic Weapon": [
		"level": "2",
		"school": "transmutation",
		"cast": "1 bonus action",
	...
	"Misty Step": [
		...
		"components": "v",
		"duration": "instant",
		"description": "Magical mist enshrouds your body, briefly bringing you into a different dimension before returning you to a location of your choice." ],
	"Prayer of Healing": [
		"level": "2",
		"school": "evocation",
		"cast": "10 minutes",
	...
	"Shatter": [
		...
		"damage": [
			...
			"type": "thunder",
			"multiplier": "3"],
		"description": "Pulses of sound radiate from a target, vibrating stone and cracking steel.  Objects made of metal, stone, crystal, or glass have disadvantage on the saving throw, and all non-magical objects in the area also take damage." ],
	"Silence": [
		"level": "2",
		"school": "illusion",
		"isRitual": true,
		...
		"shape": [
			"size": "20",
			"shape": "sphere" ],
		"description": "Mute an area, muffling all sound and deafening those caught in the area.  Attempting to cast verbal spells, as well as damage from thunder and sound sources, have no effect here." ],
	"Spider Climb": [
		"level": "2",
		"school": "transmutation",
		"cast": "1 action",
	...
	"Spiritual Weapon": [
		...
		"damage": [
			...
			"type": "force",
			"multiplier": "1"],
		"description": "Summon a floating, ethereal weapon of your choice, which you can move and attack with independently." ],
	"Suggestion": [
		"level": "2",
		"school": "enchantment",
		"cast": "1 action",
		...
		"save": [
			"stat": "wis",
			"success": "no_effect" ],
		"description": "In just a sentence or two, you describe a reasonable suggestion to a creature, at which they enthusiastically comply." ],
	"Warding Bond": [
		"level": "2",
		"school": "abjuration",
		"cast": "1 action",
	...
	"Web": [
		...
		"damage": [
			...
			"type": "fire",
			"multiplier": "2"],
		"description": "Sticky strands of silk cover an area, creating difficult terrain and ensnaring anyone wishing to pass through.  A creature caught in the web must use their Strength to break free.  The webs can also be lit aflame, burning anyone in the area." ],
	//MARK: Level 3 Spells
	//MARK: Level 4 Spells
	//MARK: Level 5 Spells
	//MARK: Level 6 Spells
