...
enum SpellKey: String {
	case level, school, cast, range, damage, damageType, components, material, duration, description, levels, requiresConcentration, atHigherLevels, shape, save, isRitual
}
