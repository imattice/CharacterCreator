...
//	"priest's pack": [
//		"type": "pack",
//		"description": 	"A backpack containing items required for blessings and warding",												],
//	"explorer's pack": [
//		"type": "pack",
//		"description": "A backpack containing items useful for discovery and exploration",					],
//	"dungeoneer's pack": [
//		"type": "pack",
//		"description":  "A backpack containing items needed for delving deep into the unknown",		],
//	"diplomat's pack": [
//		"type": "pack",
//		"description":  "A backpack containing items useful for social collaboration and drawing up documents",															],
//	"burglar's pack": [
//		"type": "pack",
//		"description": 	"A backpack containing items usesd to create traps, break locks, and make a getaway"																				],
//	"entertainer's pack": [
//		"type": "pack",
//		"description": "A backpack containing items useful for making others happy and creating a distraction",										],
////	"thieves's tools": [
////		"type": "pack",
////		"description": "A backpack containing",																																],
//	"scholar's pack": [
//		"type": "pack",
//		"description": 	"A backpack containing items to study and take notes",				],
//
//	//other
//	"holy symbol": [
//		"type": "other",
